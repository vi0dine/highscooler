  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    methods: {
      newFieldOfStudy: function newFieldOfStudy() {
        console.log("".concat(window.location.hostname, ":").concat(window.location.port, "/fields/new")); // window.location.replace(`${window.location.hostname}:${window.location.port}/fields/new`)
      }
    }
  });
});
...
/******/ });
//# sourceMappingURL=admin_panel-0bfae2854769984b2302.js.map