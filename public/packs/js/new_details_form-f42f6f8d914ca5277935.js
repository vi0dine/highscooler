  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    methods: {
      generateFormula: function generateFormula() {
        var formattedSubjects = this.subjects.forEach(this.formatSubject);
        console.log(this.subjects);
        console.log(formattedSubjects);
      },
      formatSubject: function formatSubject(subject) {
        return "(".concat(subject, "_Pp*").concat(this.basic_ratio, ")|(").concat(subject, "_Pr*").concat(this.advanced_ratio, ")");
      }
    }
  });
});
...
/******/ });
//# sourceMappingURL=new_details_form-f42f6f8d914ca5277935.js.map