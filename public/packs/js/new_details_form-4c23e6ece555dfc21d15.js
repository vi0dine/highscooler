  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    methods: {
      generateFormula: function generateFormula() {
        this.subjects.forEach(this.formatSubject(subject));
        console.log(this.subjects);
        console.log(this.formula);
      },
      formatSubject: function formatSubject(subject) {
        var elem = "(".concat(subject, "_Pp*").concat(this.basic_ratio, ")|(").concat(subject, "_Pr*").concat(this.advanced_ratio, ")");
        formula += elem;
      }
    }
  });
...
/******/ });
//# sourceMappingURL=new_details_form-4c23e6ece555dfc21d15.js.map