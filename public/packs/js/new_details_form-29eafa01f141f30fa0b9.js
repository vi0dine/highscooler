...
document.addEventListener("DOMContentLoaded", function () {
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    methods: {
      generateFormula: function generateFormula() {
        var _this = this;

        if (this.counter > 0) this.formula += "+[";else this.formula += "[";
        this.counter += 1;
        this.subjects.forEach(function (subject) {
          var elem = "(".concat(subject, "_Pp*").concat(_this.basic_ratio, ")|(").concat(subject, "_Pr*").concat(_this.advanced_ratio, ")|");
          _this.formula += elem;
        });
      ...
      resetFormula: function resetFormula() {
        this.formula = "";
        this.subjects = [];
        this.basic_ratio = 0;
        this.advanced_ratio = 0;
      ...
      confirmFormula: function confirmFormula() {
...
/******/ });
//# sourceMappingURL=new_details_form-29eafa01f141f30fa0b9.js.map